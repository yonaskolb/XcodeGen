        ...
        for platform in Platform.allCases {
            let appTarget = Target(
                ...
                dependencies: [
                    ...
                    Dependency(type: .carthage(findFrameworks: false, static: false), reference: "Alamofire"),
                    Dependency(type: .carthage(findFrameworks: false, static: false), reference: "BrightFutures"),
                ],
                scheme: scheme
            )
