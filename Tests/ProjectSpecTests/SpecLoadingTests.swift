    ...
    func testProjectSpecParser() {
        ...
        describe {
            ...
            $0.it("parses target dependencies") {
                ...
                try expect(target.dependencies[3]) == Dependency(type: .target, reference: "project/name", embed: false)
                try expect(target.dependencies[4]) == Dependency(type: .carthage(findFrameworks: true), reference: "name")
