    ...
    func testSourceGenerator() {
        describe {
            ...
            $0.it("add only carthage dependencies with same platform") {
                ...
                let watchTarget = Target(name: "Watch", type: .watch2App, platform: .watchOS, sources: ["A"], dependencies: [Dependency(type: .carthage(findFrameworks: false, static: false), reference: "Alamofire_watch")])
                let watchDependency = Dependency(type: .target, reference: "Watch")
                let target = Target(name: "Test", type: .application, platform: .iOS, sources: ["A"], dependencies: [Dependency(type: .carthage(findFrameworks: false, static: false), reference: "Alamofire"), watchDependency])
            ...
            $0.it("derived directories are sorted last") {
                ...
                let target = Target(name: "Test", type: .application, platform: .iOS, sources: ["A", "P", "S"], dependencies: [Dependency(type: .carthage(findFrameworks: false, static: false), reference: "Alamofire")])
                let project = Project(basePath: directoryPath, name: "Test", targets: [target])
            ...
            $0.it("sorts files") {
                ...
                let target = Target(name: "Test", type: .application, platform: .iOS, sources: ["Sources"], dependencies: [Dependency(type: .carthage(findFrameworks: false, static: false), reference: "Alamofire")])
                let project = Project(basePath: directoryPath, name: "Test", targets: [target])
