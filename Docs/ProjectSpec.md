...
- [ ] **storeKitConfiguration**: **[StoreKitConfiguration](#storekitconfiguration)** or **string** - specify storekit configuration to use during run
...
- [ ] **storeKitConfiguration**: **[StoreKitConfiguration](#storekitconfiguration)** or **string** - `run` action can specify a storekit configuration
...
- [ ] **forWorkspace**: **Bool** - whether the scheme will be used within a `.xcworkspace` rather than `.xcodeproj`
