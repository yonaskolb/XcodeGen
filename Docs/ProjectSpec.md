...
- [ ] **inferPlatformFiltersByPath**: **Bool** - This is a convenience filter that helps you to filter the files if their pathes match these patterns `**/<supportedPlatforms>/*` or `*_<supportedPlatforms>.swift`. Note, if you use `platformFilters` this flag will be ignored.
