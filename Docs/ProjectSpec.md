...
- [ ] **inferPlatformFiltersByPath**: **Bool** - This is a convenience flag. It helps you to filter the files if they match these patterns `**/<supportedPlatforms>/*` or `*_<supportedPlatforms>.swift`. Note, if you use `platformFilters` this flag will be ignored.
