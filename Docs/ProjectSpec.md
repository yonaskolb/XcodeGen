...
Carthage offically supports static frameworks. In this case, frameworks are expected to be in `CARTHAGE_BUILD_PATH/PLATFORM/Static/FRAMEWORK.framework`.
You can use `static` option to use Carthage static frameworks instead of dynamic ones.
