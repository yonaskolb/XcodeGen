...
- [ ] **storeKitConfiguration**: **[StoreKitConfiguration](#storekitconfiguration)** or **String** - specify storekit configuration to use during run. When **String** is used, a default path prefix of `../../` will be prepended to the location
...
- [ ] **storeKitConfiguration**: **[StoreKitConfiguration](#storekitconfiguration)** or **String** - `run` action can specify a storekit configuration. When **String** is used, a default path prefix of `../../` will be prepended to the location
...
- [x] **location**: **String** - path to `.storekit` configuration file
- [ ] **pathPrefix**: **String** - prefix to be prepended to the location, default "../../", useful when using `.xcworkspace` rather than `.xcodeproj`
