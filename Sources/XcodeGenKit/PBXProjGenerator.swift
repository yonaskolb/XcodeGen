...
public class PBXProjGenerator {
    ...
    func generateTarget(_ target: Target) throws {
        ...
        let sourceFiles = try sourceGenerator
            .getAllSourceFiles(targetType: target.type, sources: target.sources, buildPhases: sourceFileBuildPhaseOverrides, platform: target.platform)
